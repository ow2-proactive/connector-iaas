...
public class InstanceRestTest {
    ...
    public void testCreateInstance() {
        ...
        assertThat(instanceRest.createInstance("infrastructureId", waitForcompletion, instanceStringFixture)
    ...
    @Test
    public void testCreateInstanceNoWaitForcompletion() {
    ...
    @Test
    public void testCreateInstanceWaitForcompletion() {
        Boolean waitForcompletion = true;
        assertThat(instanceRest.createInstance("infrastructureId", waitForcompletion, instanceStringFixture)
                .getStatus(), is(Response.Status.OK.getStatusCode()));
        verify(instanceService, times(1)).createInstanceAndWaitForCompletion("infrastructureId",
                instanceFixture);
    }
