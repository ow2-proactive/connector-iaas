...
public class InstanceFixture {
    ...
    public static String getInstanceAsaString(String id, String tag, String image, String number,
        ...
        JSONObject jsonObject = new JSONObject(getInstance(id, tag, image, number, minRam, minCores,publicAddress,privateAddress, status));
    ...
    public static Instance getInstance(String id, String tag, String image, String number, String minRam,
        ...
        return new Instance(id, tag, image, number, status, HardwareFixtures.getHardware(minRam, minCores),NetworkFixtures.getNetwork(publicAddress, privateAddress),
