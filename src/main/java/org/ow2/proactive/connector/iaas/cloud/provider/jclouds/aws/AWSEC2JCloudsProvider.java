...
public class AWSEC2JCloudsProvider extends JCloudsProvider {
    ...
    // Store the infrastructures which use the auto-generated security group, so that it can be removed when delete infrastructure.
    public Set<String> usingAutoGeneratedSecurityGroupInfrastructures = new HashSet<>();
    ...
    public Set<Instance> createInstance(Infrastructure infrastructure, Instance instance) {
        ...
        Optional.ofNullable(instance.getOptions())
                .ifPresent(options -> addOptions(template, options, infrastructure.getId()));
    ...
    private void addOptions(Template template, Options options, String infrastructureId) {
    ...
    public void deleteInfrastructure(Infrastructure infrastructure) {
        ...
        if (usingAutoGeneratedSecurityGroupInfrastructures.contains(infrastructure.getId())) {
        ...
        usingAutoGeneratedSecurityGroupInfrastructures.remove(infrastructure.getId());
    }
